# Guia de uso do TREM — Sistema de Gestão da Plante Comunicação
...
7. [Aprovação de peça pelo cliente](#7-aprovação-de-peça-pelo-cliente)
8. [Calendário editorial](#8-calendário-editorial)
9. [Agenda da agência](#9-agenda-da-agência)
10. [Propostas](#10-propostas)
11. [Mídia (PI)](#11-mídia-pi)
12. [Tráfego / anúncios](#12-tráfego--anúncios)
13. [Produção e Serviços/OS](#13-produção-e-serviçosos)
14. [Atas de reunião](#14-atas-de-reunião)
15. [Financeiro](#15-financeiro)
16. [Central de Reembolsos](#16-central-de-reembolsos)
17. [Contratos e Saúde Financeira](#17-contratos-e-saúde-financeira)
18. [Nota fiscal (NFS-e)](#18-nota-fiscal-nfs-e)
19. [Indicadores e Alertas](#19-indicadores-e-alertas)
20. [Relatórios](#20-relatórios)
21. [Clientes: visão 360, brand kit, onboarding, portal](#21-clientes)
22. [Outros cadastros](#22-outros-cadastros)
23. [Administração](#23-administração)
...
- **Confiar neste dispositivo (2FA):** na tela do código, deixe marcado **"Confiar neste
  dispositivo por 30 dias"** e aquele navegador **pula o código 2FA** nos próximos 30 dias
  (a **senha continua** sendo pedida sempre). Cada login renova o prazo. Desativar e reativar
  o 2FA nas configurações **descadastra todos os dispositivos** confiáveis.
- **Segurança do login:** 5 tentativas erradas em 15 minutos **bloqueiam** o acesso daquele
  e-mail por 15 minutos.
- **Sessão:** por segurança, você é **desconectado após 4 horas de inatividade**. Antes
  disso aparece um aviso "sua sessão vai expirar" com o botão **Continuar conectado**.
  Enquanto você está usando, a sessão se renova sozinha.

**Sua conta** (menu do avatar, canto superior direito):
...
> têm um checklist de etapas (nesses, você conclui marcando a sua etapa no checklist).
>
...
A agenda reúne, num calendário só, **todos os compromissos da agência** — reuniões,
gravações, visitas, prazos — para o time inteiro enxergar a semana no mesmo lugar. É
diferente do Calendário editorial (seção 8), que é só das postagens. Fica em **Agenda**
no menu e é visível para **todos**.

**Como usar:** **Agenda, Novo compromisso**. Campos:
- **Título** e **Tipo** (reunião, gravação, visita, prazo, financeiro ou outro — cada tipo
  tem uma cor no calendário).
- **Cliente** (opcional) e **Data**. Marque **Dia inteiro** ou informe **hora de início e fim**.
- **Local** (endereço, sala, link do Meet).
- **Participantes (equipe):** marque quem participa — o botão **Marcar todos** seleciona o
  time inteiro de uma vez.
- **Convidados externos (e-mails):** pessoas de fora do time (cliente, fornecedor). Separe
  por vírgula ou quebra de linha.
- **Recorrência:** **não se repete** ou **a cada 7, 15 ou 30 dias**, com um **"repetir até"**
  opcional. O compromisso recorrente aparece sozinho em todas as datas (ícone 🔁).

**Avisos:**
- **Notificação no sino:** os participantes são avisados quando entram num compromisso.
- **E-mail (opcional):** a caixinha **"Avisar os envolvidos por e-mail"** (marcada por padrão)
  manda o convite — com data, local e a **lista de participantes** — para o time e os
  convidados externos.
- **Comentários:** cada compromisso tem comentários com **@menção**, igual aos jobs.

**Reunião vira ata:** compromissos do tipo **Reunião** aparecem em **Atas de reunião** (seção
14), no bloco **"Reuniões da agenda sem ata"**. O botão **Criar ata** já abre a ata **vinculada**
e pré-preenchida (título, data, cliente, participantes) — é só escrever o conteúdo.

**Assinar no Google/Apple Agenda:** o painel **"Assinar no Google/Apple Agenda"** mostra um
**link (.ics)**. No Google: *Outras agendas → + → Assinar de um URL* e cole o link; no Apple:
*Arquivo → Nova assinatura de calendário*. A agenda **atualiza sozinha** (é somente leitura no
Google). Gestores podem **gerar um link novo** se o antigo vazar (o anterior para de funcionar).

- **Quem edita/exclui:** quem **criou** o compromisso ou um **gestor**.

> **Boas práticas:** ponha o **link do Meet** no campo Local e marque os **participantes** —
> assim todo mundo recebe o aviso e o convite por e-mail já sai completo. Para reunião com
> cliente, crie a **ata** direto do compromisso, para a decisão ficar registrada.
...
- **Reunião veio da agenda:** compromissos do tipo **Reunião** (Agenda, seção 9) aparecem
  aqui no bloco **"Reuniões da agenda sem ata"**, com o botão **Criar ata** — a ata já nasce
  **vinculada** e pré-preenchida (título, data, cliente, participantes). Também dá para criar
  a ata direto de dentro do compromisso.
...
## 17. Contratos e Saúde Financeira
